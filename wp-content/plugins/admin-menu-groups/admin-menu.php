...
function amg_get_sub_positions() {
    ...
    $order = json_decode($options['amg_field_menu_order'], true)['order'];
...
function amg_get_groups_to_add() {
    ...
    $options = get_option( 'amg_options' );
    $grouplist = json_decode($options['amg_field_menu_order'], true)['groups'];
...
function amg_get_hidden_list() {
    $options = get_option( 'amg_options' );
    $hidden = json_decode($options['amg_field_menu_order'], true)['hidden'];
